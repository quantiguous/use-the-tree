...
//				if (verbosity>10)
//					curTree = curTree.addChild("Service_String_Advice");
//				else
...
//					if (verbosity>10)
//						curTree = curTree.addChild("Interchange_Header");
//					else
...
//							curTree.addChild("SI");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								...
								curTree.addChild("si").value = componentElements[0];
						else if (strict)
						...
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								...
								curTree.addChild("svn").value = componentElements[1];
						else if (strict)
					...
					if (dataElements.length>3&&!dataElements[3].replace(componentDataElementSeparator, "").equals("")) {
						...
						if (componentElements.length>2&&!componentElements[2].equals(""))
							if (verbosity>0)
								curTree.lastChild.addChild("RoutingAddress").value = componentElements[2];
							else
								curTree.lastChild.addChild("ra").value = componentElements[2];
...
//							curTree.addChild("RRP");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("RecipientsReferencePassword").value = componentElements[0];
							else
								curTree.addChild("rrp").value = componentElements[0];
						else if (strict)
							throw new Exception("Recipient's Reference Password is mandatory but missing");
						
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								curTree.addChild("RecipientsReferencePasswordQualifier").value = componentElements[1];
							else
								curTree.addChild("rrpq").value = componentElements[1];
...
//					if (verbosity>10)
//						curTree = curTree.addChild("Interchange_Trailer");
//					else
...
//					if (verbosity>10)
//						curTree = curTree.addChild("Functional_Group_Header");
//					else
...
//							curTree.addChild("ASI");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("ApplicationSendersIdentification").value = componentElements[0];
							else
								curTree.addChild("asi").value = componentElements[0];
						else if (strict)
...
//							curTree.addChild("ARI");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("RecipientsIdentification").value = componentElements[0];
							else
								curTree.addChild("ri").value = componentElements[0];
						else if (strict)
							throw new Exception("Recipient's Identification is mandatory but missing");
						
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								curTree.addChild("RecipientsIdentificationQualifier").value = componentElements[1];
							else
								curTree.addChild("riq").value = componentElements[1];
...
//							curTree.addChild("MV");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("MessageVersionNumber").value = componentElements[0];
							else
								curTree.addChild("mvn").value = componentElements[0];
						else if (strict)
							throw new Exception("Message Version Number is mandatory but missing");
						
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								curTree.addChild("MessageReleaseNumber").value = componentElements[1];
							else
								curTree.addChild("mrn").value = componentElements[1];
						else if (strict)
							throw new Exception("Message Release Number is mandatory but missing");
					
						if (componentElements.length>2&&!componentElements[2].equals(""))
							if (verbosity>0)
								curTree.addChild("AssociationAssignedCode").value = componentElements[2];
							else
								curTree.addChild("aac").value = componentElements[2];
...
//					if (verbosity>10)
//						curTree = curTree.addChild("Functional_Group_Trailer");
//					else
...
//					if (verbosity>10)
//						curTree = curTree.addChild("Message_Header");
//					else
...
//							curTree.addChild("MI");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("MessageType").value = componentElements[0];
							else
								curTree.addChild("mt").value = componentElements[0];
						else if (strict)
							throw new Exception("Message Type is mandatory but missing");
						
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								curTree.addChild("MessageVersionNumber").value = componentElements[1];
							else
								curTree.addChild("mvn").value = componentElements[1];
						else if (strict)
							throw new Exception("Message Version Number is mandatory but missing");
					
						if (componentElements.length>2&&!componentElements[2].equals(""))
							if (verbosity>0)
								curTree.addChild("MessageReleaseNumber").value = componentElements[2];
							else
								curTree.addChild("mrn").value = componentElements[2];
						else if (strict)
							throw new Exception("Message Release Number is mandatory but missing");
					
						if (componentElements.length>3&&!componentElements[3].equals(""))
							if (verbosity>0)
								curTree.addChild("ControllingAgency").value = componentElements[3];
							else
								curTree.addChild("ca").value = componentElements[3];
						else if (strict)
							throw new Exception("Controlling Agency is mandatory but missing");
						...
						if (componentElements.length>4&&!componentElements[4].equals(""))
							if (verbosity>0)
								...
								curTree.addChild("AAC").value = componentElements[4];
...
//							curTree.addChild("SOTT");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("SequenceOfTransfers").value = componentElements[0];
							else
								curTree.addChild("sot").value = componentElements[0];
						else if (strict)
							throw new Exception("Sequence Of Transfers is mandatory but missing");
						
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								curTree.addChild("FirstAndLastTransfer").value = componentElements[1];
							else
								curTree.addChild("falt").value = componentElements[1];
					}
...
//					if (verbosity>10)
//						curTree = curTree.addChild("Message_Trailer");
//					else
...
//					curTree = curTree.parent;
					...
					if (dataElements.length>1&&!dataElements[1].equals(""))
						...
						if (strict)
							if (!dataElements[1].equals("S"))
								throw new Exception("SECTION IDENTIFICATION - Section identification MUST BE \"S\"");
					
					if (lineStarted) {
						curTree = curTree.parent.parent;
						lineStarted=false;
					} else if (strict)
						throw new Exception("UNS SECTION IDENTIFICATION - but no LIN (lines) before");
					
				} else if (line.startsWith("LIN")) {
					
					if (!lineStarted) {
						if (verbosity>10) {
							curTree = curTree.addChild("LINE_ITEMS");
							curTree = curTree.addChild("LINE_ITEM");
						}
						else {
							curTree = curTree.addChild("LINES");
							curTree = curTree.addChild("LINE");
						}
						lineStarted=true;
					} else {
						curTree = curTree.parent;
...
//							curTree.addChild("INI");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("ItemIdentifier").value = componentElements[0];
							else 
								curTree.addChild("ii").value = componentElements[0];
						
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								curTree.addChild("ItemTypeIdentificationCode").value = componentElements[1];
							else
								curTree.addChild("itic").value = componentElements[1];
						
						if (componentElements.length>2&&!componentElements[2].equals(""))
							if (verbosity>0)
								curTree.addChild("CodeListIdentificationCode").value = componentElements[2];
							else
								curTree.addChild("clic").value = componentElements[2];
						
						if (componentElements.length>3&&!componentElements[3].equals(""))
							if (verbosity>0)
								curTree.addChild("CodeListResponsibleAgencyCode").value = componentElements[3];
							else
								curTree.addChild("clrac").value = componentElements[3];
					}
...
//							curTree.addChild("SLI");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("SubLineIndicatorCode").value = componentElements[0];
							else
								curTree.addChild("slic").value = componentElements[0];
						
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								curTree.addChild("LineItemIdentifier").value = componentElements[1];
							else
								curTree.addChild("lii").value = componentElements[1];
					}
...
//							curTree.addChild("QD");
					...
					if (componentElements.length>0&&!componentElements[0].equals(""))
						if (verbosity>0)
							curTree.addChild("QuantityTypeCodeQualifier").value = componentElements[0];
						else
							curTree.addChild("qtcq").value = componentElements[0];
					else if (strict)
						throw new Exception("Quantity Type Code Qualifier is mandatory but missing");
					
					if (componentElements.length>1&&!componentElements[1].equals(""))
						if (verbosity>0)
							curTree.addChild("Quantity").value = componentElements[1];
						else
							curTree.addChild("qty").value = componentElements[1];
					else if (strict)
						throw new Exception("Quantity is mandatory but missing");
					
					if (componentElements.length>2&&!componentElements[2].equals(""))
						if (verbosity>0)
							curTree.addChild("MeasurementUnitCode").value = componentElements[2];
						else
							curTree.addChild("muc").value = componentElements[2];
...
//					if (verbosity>10)
//						curTree = curTree.addChild("DATE_TIME_PERIOD");
//					else
...
//							curTree.addChild("DMN");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("DocumentNameCode").value = componentElements[0];
							else
								curTree.addChild("dnc").value = componentElements[0];
						...
						if (componentElements.length>3&&!componentElements[3].equals(""))
							if (verbosity>0)
								curTree.addChild("DocumentName").value = componentElements[3];
							else
								curTree.addChild("dn").value = componentElements[3];
					}
...
//							curTree.addChild("DMI");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("DocumentIdentifier").value = componentElements[0];	
							else
								curTree.addChild("di").value = componentElements[0];	
							
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								curTree.addChild("VersionIdentifier").value = componentElements[1];
							else
								curTree.addChild("vi").value = componentElements[1];
						
						if (componentElements.length>2&&!componentElements[2].equals(""))
							if (verbosity>0)
								curTree.addChild("RevisionIdentifier").value = componentElements[2];
							else
								curTree.addChild("ri").value = componentElements[2];
					}	
...
//					curTree = curTree.parent;
					...
					if (verbosity>10)
						curTree = curTree.addChild("NAME_AND_ADDRESS");
					else
...
//							curTree.addChild("PID");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								...
								curTree.addChild("pi").value = componentElements[0];	
						else if (strict)
							throw new Exception("Party Identifier is mandatory but missing");
						
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								curTree.addChild("CodeListIdentificationCode").value = componentElements[0];	
							else
								curTree.addChild("clic").value = componentElements[0];	
						
						if (componentElements.length>2&&!componentElements[2].equals(""))
							if (verbosity>0)
								curTree.addChild("CodeListResponsibleAgencyCode").value = componentElements[0];	
							else
								curTree.addChild("clrac").value = componentElements[0];	
...
//							curTree.addChild("NAA");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								...
								curTree.addChild("naad").value = componentElements[0];	
						else if (strict)
						...
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								...
								curTree.addChild("naad").value = componentElements[1];	
						
						if (componentElements.length>2&&!componentElements[2].equals(""))
							if (verbosity>0)
								curTree.addChild("NameAndAddressDescription").value = componentElements[2];	
							else
								curTree.addChild("naad").value = componentElements[2];	
						
						if (componentElements.length>3&&!componentElements[3].equals(""))
							if (verbosity>0)
								curTree.addChild("NameAndAddressDescription").value = componentElements[3];	
							else
								curTree.addChild("naad").value = componentElements[3];	
...
//							curTree.addChild("PN");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								...
								curTree.addChild("pn").value = componentElements[0];
						else if (strict)
						...
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								...
								curTree.addChild("pn").value = componentElements[1];
						
						if (componentElements.length>2&&!componentElements[2].equals(""))
							if (verbosity>0)
								curTree.addChild("PartyName").value = componentElements[2];	
							else
								curTree.addChild("pn").value = componentElements[2];
						
						if (componentElements.length>3&&!componentElements[3].equals(""))
							if (verbosity>0)
								curTree.addChild("PartyName").value = componentElements[3];	
							else
								curTree.addChild("pn").value = componentElements[3];
						
						if (componentElements.length>4&&!componentElements[4].equals(""))
							if (verbosity>0)
								curTree.addChild("PartyName").value = componentElements[4];	
							else
								curTree.addChild("pn").value = componentElements[4];
...
//							curTree.addChild("STREET");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("StreetAndNumber").value = dataElements[0];	
							else
								curTree.addChild("san").value = dataElements[0];
						else if (strict)
							throw new Exception("Street and Number or Post Office Box Identifier is mandatory but missing");
						
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								curTree.addChild("StreetAndNumber").value = dataElements[1];	
							else
								curTree.addChild("san").value = dataElements[1];
					
						if (componentElements.length>2&&!componentElements[2].equals(""))
							if (verbosity>0)
								curTree.addChild("StreetAndNumber").value = dataElements[2];	
							else
								curTree.addChild("san").value = dataElements[2];					
					
						if (componentElements.length>3&&!componentElements[3].equals(""))
							if (verbosity>0)
								curTree.addChild("StreetAndNumber").value = dataElements[3];	
							else
								curTree.addChild("san").value = dataElements[3];	
					}
...
//							curTree.addChild("CSED");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("CountrySubEntityNameCode").value = dataElements[0];	
							else
								curTree.addChild("csenc").value = dataElements[0];
					...
					if (verbosity>10)
						curTree = curTree.addChild("FREE_TEXT");
					else
...
//							curTree.addChild("TR");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("FreeTextValueCode").value = componentElements[0];	
							else
								curTree.addChild("ftvc").value = componentElements[0];
						else if (strict)
...
//							curTree.addChild("TL");
						...
						if (componentElements.length>0&&!componentElements[0].equals(""))
							if (verbosity>0)
								curTree.addChild("FreeTextValue").value = componentElements[0];	
							else
								curTree.addChild("ftv").value = componentElements[0];
						else if (strict)
							throw new Exception("Free Text Value is mandatory but missing");
					
						if (componentElements.length>1&&!componentElements[1].equals(""))
							if (verbosity>0)
								curTree.addChild("FreeTextValue").value = componentElements[1];	
							else
								curTree.addChild("ftv").value = componentElements[1];
						
						if (componentElements.length>2&&!componentElements[2].equals(""))
							if (verbosity>0)
								curTree.addChild("FreeTextValue").value = componentElements[2];	
							else
								curTree.addChild("ftv").value = componentElements[2];
						
						if (componentElements.length>3&&!componentElements[3].equals(""))
							if (verbosity>0)
								curTree.addChild("FreeTextValue").value = componentElements[3];	
							else
								curTree.addChild("ftv").value = componentElements[3];
						
						if (componentElements.length>4&&!componentElements[4].equals(""))
							if (verbosity>0)
								curTree.addChild("FreeTextValue").value = componentElements[4];	
							else
								curTree.addChild("ftv").value = componentElements[4];
					}
...
//					if (verbosity>10)
//						curTree = curTree.addChild("CONTROL_TOTAL");
//					else
